...
router.post("/createuser", [body("name", "Enter the valid name").isLength({ min: 3 }), body("email", "Enter the valid email").isEmail(), body("password", "Password must be of min 4 characters").isLength({ min: 4 })], async (req, res) => {
	let success = false;
...
// route:4 Update user details, /update, login required
